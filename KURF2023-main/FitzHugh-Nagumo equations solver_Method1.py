...
All_Pwaves_Lii = np.zeros((((n_divs-1)*(m_divs-1)), eff_iterns), dtype=float)
All_Pwaves_Liii = np.zeros((((n_divs-1)*(m_divs-1)), eff_iterns), dtype=float)
All_Pwaves_WCT = np.zeros((((n_divs-1)*(m_divs-1)), eff_iterns), dtype=float)
All_Pwaves_V1 = np.zeros((((n_divs-1)*(m_divs-1)), eff_iterns), dtype=float)
All_Pwaves_V2 = np.zeros((((n_divs-1)*(m_divs-1)), eff_iterns), dtype=float)
All_Pwaves_V3 = np.zeros((((n_divs-1)*(m_divs-1)), eff_iterns), dtype=float)
All_Pwaves_V4 = np.zeros((((n_divs-1)*(m_divs-1)), eff_iterns), dtype=float)
All_Pwaves_V5 = np.zeros((((n_divs-1)*(m_divs-1)), eff_iterns), dtype=float)
All_Pwaves_V6 = np.zeros((((n_divs-1)*(m_divs-1)), eff_iterns), dtype=float)
All_Pwaves_aVF = np.zeros((((n_divs-1)*(m_divs-1)), eff_iterns), dtype=float)
